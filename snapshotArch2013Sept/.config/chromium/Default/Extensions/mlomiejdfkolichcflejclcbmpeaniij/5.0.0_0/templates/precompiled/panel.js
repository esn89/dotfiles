...
with(obj||{}){
__p+='<div id="tooltip" class="message"></div>\n<div id="close-panel"></div>\n<div id="header">\n\t<div id="header-icon"></div>\n\t<div id="header-text">\n\t\t<div class="vertical-center" style="height: 55px; width: 210px;">\n\t\t\t<div id="ghostery-findings-text" class="ellipsis">'+
((__t=( t('panel_title_not_scanned') ))==null?'':_.escape(__t))+
'</div>\n\t\t</div>\n\t\t<div id="website-info">\n\t\t\t<div id="website-url" class="ellipsis left"></div>\n\t\t\t<div id="website-whitelisted" class="left">&nbsp;'+
((__t=( t('panel_subtitle_whitelisted') ))==null?'':__t)+
...
'</div>\n\n\t<div id="tutorial-screens">\n\n\t\t<div id="tutorial-screen-1" class="tutorial-screen">\n\t\t\t<div class="vertical-center">\n\t\t\t\t<div class="title-large">'+
...
'</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div id="tutorial-screen-10" class="tutorial-screen">\n\t\t\t<div class="vertical-center">\n\t\t\t\t<div class="title-large">'+
