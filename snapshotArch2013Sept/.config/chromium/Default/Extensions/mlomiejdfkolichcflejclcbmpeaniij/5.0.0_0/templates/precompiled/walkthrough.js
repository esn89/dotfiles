...
((__t=( t('welcome_to_ghostery', '<span id="version-text"></span>') ))==null?'':__t)+
'\n\t\t</p>\n\t\t<p>\n\t\t\t'+
...
'\n\t\t</p>\n\t\t<p>\n\t\t\t'+
((__t=( t('walkthrough_autoupdate3') ))==null?'':_.escape(__t))+
'\n\t\t</p>\n\t\t<p>\n\t\t\t<label>\n\t\t\t\t<input type="checkbox" id="enable-autoupdate"';
 if (conf.enable_autoupdate) print(' checked') 
__p+='>\n\t\t\t\t'+
((__t=( t('walkthrough_autoupdate_checkbox') ))==null?'':_.escape(__t))+
