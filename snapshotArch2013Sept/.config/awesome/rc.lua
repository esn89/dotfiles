...
beautiful.init("/home/ep/.config/awesome/powerarrowf/theme.lua")
...
vicious.register(netwidget, vicious.widgets.net, function(widgets,args)
        ...
        return '<span font="Inconsolata 11" color="#AAAAAA" background="#1F2428">' ..args["{"..interface.." down_kb}"]..'kbps'..'</span>' end, 10)
...
vicious.register(mailtext, vicious.widgets.gmail, function(widgets, args)
        local message = ""
        ...
        return '<span font="Inconsolata 11" color="#AAAAAA" background="#313131">' .. message .. ' </span>' end, 120)
